...
public class StockItemController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Insert([FromBody] StockItem entity)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] StockItem entity)
    {
    ...
    [HttpDelete]
    public IActionResult Delete([FromBody] StockItem entity)
    {
