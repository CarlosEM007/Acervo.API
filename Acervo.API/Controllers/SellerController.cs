...
public class SellerController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Insert([FromBody] Seller entity)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] Seller entity)
    {
    ...
    [HttpDelete]
    public IActionResult Delete([FromBody] Seller entity)
    {
